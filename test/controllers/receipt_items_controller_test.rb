...
class ReceiptItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receipt_item" do
    assert_difference('ReceiptItem.count') do
      post receipt_items_url, params: { receipt_item: { analysis_id: @receipt_item.analysis_id, price: @receipt_item.price, receipt_id: @receipt_item.receipt_id } }
    end
  ...
  test "should update receipt_item" do
    patch receipt_item_url(@receipt_item), params: { receipt_item: { analysis_id: @receipt_item.analysis_id, price: @receipt_item.price, receipt_id: @receipt_item.receipt_id } }
