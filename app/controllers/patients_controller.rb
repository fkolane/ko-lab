class PatientsController < ApplicationController
  ...
  private
    ...
    def patient_params
      params.require(:patient).permit(:identifier, :first_name, :last_name, :birth_date, :gender, :ethnic_group_id, :born_place, :locality_id, :address, :phone, :father_first_name, 
